...
public partial class InterpolateTests {
    ...
    public void Should_handle_captured_local() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(value));
    ...
    public void Should_handle_captured_local_anonymous_class_instance() {
        ...
        var expected = ExpressionOnNone.Of(() => "foo");
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(value.Foo));
    ...
    public void Should_handle_captured_local_in_binary_expression() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(value + "bar"));
    ...
    public void Should_handle_captured_local_in_methodcallexpression() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(string.Concat("bar", value)));
    ...
    public void Should_handle_captured_local_in_new_expression() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(new string(c, count)));
    ...
    public void Should_handle_captured_local_in_object_initializer() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(new Cat { Name = value }));
    ...
    public void Should_handle_captured_local_in_list_initializer() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(new List<string>(count) { value }));
    ...
    public void Should_handle_captured_local_in_lambda() {
        ...
        var interpolated = ExpressionOnNone.Interpolate(x => x.SpliceValue(
            Array.Empty<Cat>().Where(c => c.Name == value)
        ));
    ...
    public void Should_handle_captured_local_in_from_clause() {
        ...
        var interpolated = InterpolationTestOnNone.Interpolate(x => x.SpliceValue(
            from c in cats
            select c.Name
        ));
