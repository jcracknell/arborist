...
public static partial class ExpressionOn<A, B, C> {
    ...
    /// </summary>
    public static Expression<Func<A, B, C, R>> Graft<I, R>(
        Expression<Func<A, B, C, I>> root,
        Expression<Func<I, R>> branch
    ) =>
        Expression.Lambda<Func<A, B, C, R>>(
    ...
    /// </summary>
    public static Expression<Func<A, B, C, R?>> GraftNullable<I, J, R>(
        Expression<Func<A, B, C, I>> root,
        ...
        where J : class?
        where R : class? =>
        ExpressionHelper.GraftNullableImpl<Func<A, B, C, R?>>(root, branch);
    ...
    /// </param>
    public static Expression<Func<A, B, C, Nullable<R>>> GraftNullable<I, J, R>(
        Expression<Func<A, B, C, I>> root,
        Expression<Func<J, R>> branch,
        ...
        where J : class?
        where R : struct =>
        ExpressionHelper.GraftNullableImpl<Func<A, B, C, Nullable<R>>>(root, branch);
    ...
    /// the non-null body of the <paramref name="root"/> expression.
    /// </summary>
    public static Expression<Func<A, B, C, R?>> GraftNullable<I, R>(
    ...
    /// Disambiguates overloads by type parameter constraints.
    /// </param>
    public static Expression<Func<A, B, C, Nullable<R>>> GraftNullable<I, R>(
        Expression<Func<A, B, C, Nullable<I>>> root,
        Expression<Func<I, R>> branch,
        Nullable<R> dummy = default
    )
