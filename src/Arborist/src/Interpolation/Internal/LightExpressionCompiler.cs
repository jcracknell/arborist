...
/// <summary>
/// <see cref="IExpressionCompiler"/> implementation using the internal expression interpreter
...
/// </summary>
public sealed class LightExpressionCompiler : IExpressionCompiler {
    public static LightExpressionCompiler Instance { get; } = new();
