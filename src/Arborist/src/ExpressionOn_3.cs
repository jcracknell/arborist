...
public static class ExpressionOn<A, B, C> {
    ...
    public static Expression<Func<A, B, C, R>> Interpolate<R>(
        ...
        ExpressionHelper.InterpolateCore<object?, Func<A, B, C, R>>(default(object), expression);
    ...
    public static Expression<Action<A, B, C>> Interpolate(
        ...
        ExpressionHelper.InterpolateCore<object?, Action<A, B, C>>(default(object), expression);
