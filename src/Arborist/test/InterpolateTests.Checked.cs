...
public partial class InterpolateTests {
    ...
    public void Should_work_for_checked_numeric_conversion() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => checked((short)(c.Id + x.SpliceConstant(42))))
        );
    }
    ...
    public void Should_work_for_checked_object_conversion() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => checked((object)(c.Id + x.SpliceConstant(42))))
        );
    }
}
