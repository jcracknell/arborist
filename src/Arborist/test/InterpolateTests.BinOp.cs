...
public partial class InterpolateTests {
    ...
    public void Should_work_for_i32_add() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Owner>.Interpolate(default(object), (x, o) => o.Id + x.SpliceValue(42))
        );
    }
    ...
    public void Should_work_for_i32_add_lifted() {
        ...
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Owner>.Interpolate(default(object), (x, o) => new int?(x.SpliceValue(42)) + null)
        );
    ...
    public void Should_work_for_i32_lt() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => c.Id < x.SpliceValue(42))
        );
    }
    ...
    public void Should_work_for_i32_lt_lifted() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => c.Age < x.SpliceValue(42))
        );
    }
    ...
    public void Should_work_for_string_add() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => c.Name + x.SpliceValue("bar"))
        );
    }
    ...
    public void Should_work_for_string_add_chained() {
        ...
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => x.SpliceValue("bar") + c.Name + c.Name)
        );
    }
    ...
    public void Should_work_for_as() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => x.SpliceValue(42) as IFormattable)
        );
    }
    ...
    public void Should_work_for_is() {
        Assert.Equivalent(
            ...
            actual: ExpressionOn<Cat>.Interpolate(default(object), (x, c) => (object?)x.SpliceValue(42) is IFormattable)
        );
    }
}
