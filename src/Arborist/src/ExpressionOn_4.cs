...
public static class ExpressionOn<A, B, C, D> {
    ...
    public static Expression<Func<A, B, C, D, R>> Interpolate<R>(
        ...
        ExpressionHelper.InterpolateCore<object?, Func<A, B, C, D, R>>(default(object), expression);
    ...
    public static Expression<Action<A, B, C, D>> Interpolate(
        ...
        ExpressionHelper.InterpolateCore<object?, Action<A, B, C, D>>(default(object), expression);
